...
// Devuelve el ID de fecha (YYYY-MM-DD) desplazado N días respecto a hoy.
// Usar offsetDays negativo para el pasado (ej: -1 = ayer). Usado por el
// Tablón de Anuncios para calcular rachas de días "flawless" consecutivos.
export const getDateIdOffset = (offsetDays = 0) => {
    const today = new Date();
    const offset = today.getTimezoneOffset();
    const localDate = new Date(today.getTime() - (offset * 60 * 1000));
