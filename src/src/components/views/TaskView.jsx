...
import SaturdayReminder from '../modals/SaturdayReminder';
import ThemeAudioPlayer from '../effects/ThemeAudioPlayer'; // Importamos el nuevo componente
...
const TaskView = ({ 
    ...
    // Nuevas props necesarias para el recordatorio del sábado:
    ...
    return (
        <div className="flex-1 flex flex-col gap-6 animate-fadeIn">
            ...
            {/* COMPONENTE DE RECORDATORIO */}
            {/* Solo se mostrará si es sábado y la prop hasSubmittedAvailability es false */}
            <SaturdayReminder 
                hasSubmittedAvailability={hasSubmittedAvailability} 
                openAvailabilityModal={onOpenAvailability}
