        ...
        if (role === 'team_leader' || role === 'admin') {
            const fetchTeam = async () => {
                try {
                    ...
                    logger.error("Error buscando agentes:", error);
                }
            };
            fetchTeam();
        }
   ...
   const handleSend = async () => {
        ...
        try {
            ...
            if (isGodMode) {
                ...
                showToast(`✅ Horario de ${targetUserName} cargado manualmente.`, 'success');
                ...
                showToast(isUrgentChange ? "🚨 SOLICITUD URGENTE ENVIADA AL TEAM LEADER" : "📩 CAMBIO ENVIADO AL TEAM LEADER", 'success');
                ...
                if (new Date().getDay() === 5 && targetWeek === 'next') { 
                    addCoins(50); 
                    showToast("✅ Guardado + 50 Coins de Bonus de Viernes", 'success'); 
                } else { 
            ...
            logger.error("Error al enviar disponibilidad:", error); 
