...
import WaterWavesEffect from './WaterWavesEffect';
import CardRippleEffect from './CardRippleEffect';
import EkgNeonEffect from './EkgNeonEffect';
...
const BackgroundEffectsManager = ({ themeClasses, activeEffect }) => {
    ...
    const EFFECT_COMPONENTS = {
        ...
        'city_lights': CityLightsEffect,
        'water_waves': WaterWavesEffect,
        'card_ripple': CardRippleEffect,
        'ekg_neon': EkgNeonEffect,
...
export default React.memo(BackgroundEffectsManager);