...
// Exportada para poder testearla de forma aislada (ver wallet.service.test.js)
export const cleanDataStructure = (data) => {
    if (!data) return 0;
...
export const getWalletBalance = async (userId) => {
    try {
        ...
        logger.error("Error en servicio getWalletBalance:", error);
        throw error;
    }
};
