...
export const useTasks = (user) => {
    ...
    const sortTasksByName = useCallback(() => {
        setTasks([...tasks].sort((a, b) => {
            const nameA = (a.rawTaskName || a.name || '').toLowerCase();
            const nameB = (b.rawTaskName || b.name || '').toLowerCase();
    ...
    return { 
        ...
        sortTasksByShop,sortTasksByName, resetTaskTimer, stopAllTimers, 
