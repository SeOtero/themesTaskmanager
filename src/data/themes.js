export const THEMES = {
  ...
  outside_the_frame: {
        id: 'outside_the_frame',
        name: 'outside_the_frame',
        label: '🌃 Outside The Frame',
        type: 'theme',
        price: 0, 
        image: '/outside_cover.png',
        description: 'Vibra urbana nocturna. Tonos ultra oscuros con destellos cálidos de neón naranja y ámbar.',
        
        // Fondos súper oscuros (cielo nocturno)
        bodyBg: 'bg-[#0a0812]', 
        // Fondo con resplandores radiales simulando luces de ciudad a lo lejos
        rawBg: 'radial-gradient(circle at 15% 90%, rgba(255, 123, 0, 0.15) 0%, transparent 40%), radial-gradient(circle at 85% 85%, rgba(255, 183, 3, 0.12) 0%, transparent 45%), linear-gradient(to bottom, #0a0812 0%, #151021 100%)',
        activeEffects: ['city_lights', 'lofi_notes'],
        // Tarjetas translúcidas con bordes naranja sutiles y un ligero resplandor
        cardBg: 'bg-[#1a1528]/80 backdrop-blur-xl border border-[#ff7b00]/30 shadow-[0_0_30px_rgba(255,123,0,0.15)]',
        
        // Textos cálidos
        primaryText: 'text-orange-50',
        secondaryText: 'text-orange-200/60',
        accentText: 'text-[#ffb703] font-bold drop-shadow-[0_0_8px_rgba(255,183,3,0.5)]',
        
        // Inputs y bordes
        inputBorder: 'border-[#ff7b00]/40 focus:border-[#ffb703]',
        shopSelectBorder: 'border-[#ff7b00]',
        
        // Botones oscuros para acciones secundarias
        buttonAction: 'bg-[#2a203b] hover:bg-[#35284a] text-orange-100 border border-[#ff7b00]/50 transition-all',
        
        // Botón principal vibrante como las luces de la calle
        buttonAdd: 'bg-gradient-to-r from-[#ff7b00] to-[#ffb703] hover:from-[#e66a00] hover:to-[#e6a500] text-black font-extrabold shadow-[0_0_20px_rgba(255,123,0,0.5)] transition-all',
        
        modalBg: 'bg-[#0f0c1b] border-[#ff7b00]/50',
        
        // Si tienes el LofiAmbience activado, puedes usarlo para darle la vibra completa
       activeEffects: ['city_lights', 'card_ripple', 'ekg_neon', 'shooting_stars'] // Puedes combinarlos o dejar solo city_lights
    },
    neon: {
        id: 'neon',
        name: 'neon', 
