...
export const shopOptions = ["Tienda Lujosa", "Clara Tienda", "Clara Tierra", "Bella Divina"];
export const LOFI_UNLOCK_HOURS = 10; 
...
export const shopSpecificCallTasks = {
    "Tienda Lujosa": "CALL Pending Orders", 
    "Clara Tienda": "CALL Pending Orders", 
    "Clara Tierra": "CALL Pending Orders",
    "Bella Divina": "CALL Pending Orders",
};